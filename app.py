...
class ResumeApp:
    def __init__(self):
        ...
        try:
            ...
            with open('style/custom_premium.css') as f:
                st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Resume Analyzer</h1>
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Resume Analyzer represents my vision of democratizing career advancement through technology.
